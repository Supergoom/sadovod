...
add_action('widgets_init', 'register_viewed_posts_widget');
function register_viewed_posts_widget()
{
    register_widget('Viewed_Posts_Widget');
}

// Добавляем новый виджет
class Viewed_Posts_Widget extends WP_Widget
{
    function __construct()
    {
        parent::__construct(
            'viewed_posts_widget',
            __('Viewed Posts', "sadovod"),
            array('description' => __('Shows viewed posts', "sadovod"),)
        );
    }

    /** Вывод виджета просмотренных записей
     *
...
?>
            ...
            <div class="viewed-posts-item card_wrap card_widget" itemscope itemtype="http://schema.org/<?= $type ?>">
    ...
    public function form($instance)
    {
        ...
        $title = isset($instance['title']) ? $instance['title'] : __('Viewed Posts', "sadovod");
